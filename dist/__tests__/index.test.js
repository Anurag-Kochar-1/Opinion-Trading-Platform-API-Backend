...
describe("Basics", () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default).post(`/reset`);
    }));
    test("Create user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).post(`/user/create/${user1}`);
    ...
    test("Get user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).get("/user/me").send({ userId: user1 });
    ...
    test("Onramp inr balance", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).post("/onramp/inr").send({ userId: user1, amount: 10000 });
    ...
    test("Check balance", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).get("/balance/inr/user-1");
        expect(res.status).toBe(200);
    ...
    test("Create symbol", () => __awaiter(void 0, void 0, void 0, function* () {
        const symbol = "TESLA";
        const res = yield (0, supertest_1.default)(index_1.default).post(`/symbol/create/${symbol}`);
        expect(res.statusCode).toBe(201);
        expect(res.body).toEqual({
            statusType: types_1.STATUS_TYPE.SUCCESS,
            statusCode: 201,
    ...
    test("Check orderbook", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).get("/orderbook");
        expect(res.statusCode).toBe(200);
...
describe("Buying", () => {
    ...
    test("Create user -> On ramp inr balance -> create symbol", () => __awaiter(void 0, void 0, void 0, function* () {
        const res1 = yield (0, supertest_1.default)(index_1.default).post(`/user/create/${user1}`);
        ...
        const res2 = yield (0, supertest_1.default)(index_1.default).post("/onramp/inr").send({ userId: user1, amount });
        ...
        const res3 = yield (0, supertest_1.default)(index_1.default).post(`/symbol/create/${symbol}`);
    ...
    test("place buy order for 'yes' type", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default).post(`/order/buy`).send({
            userId: user1,
            stockSymbol: symbol,
            quantity: 10,
            price: 6,
        ...
        const res2 = yield (0, supertest_1.default)(index_1.default).get("/orderbook");
...
describe("Selling", () => {
    ...
    test("mint", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.default).post("/trade/mint").send({
            userId: user1,
            stockSymbol: symbol,
            quantity: 10,
        });
    ...
    test("place sell order for 'yes' type", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default).post(`/order/sell`).send({
            userId: user1,
            stockSymbol: symbol,
            quantity: 5,
            price: 1,
